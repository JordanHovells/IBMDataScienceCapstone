...
def get_scatter(entered_site, payload):
    ...
    if entered_site == 'All Sites':
        fig = px.scatter(filtered_df2,x="Payload Mass (kg)",y="class",color="Booster Version Category", title = 'Payload and Success for All sites')
        return fig

    else:
        filtered_df2 = filtered_df2[filtered_df2['Launch Site'] == entered_site]
        title = f"Total Success Launches for site {entered_site}"
        fig = px.scatter(filtered_df2,x="Payload Mass (kg)",y="class",color="Booster Version Category", title = 'Payload and Success forselected site')
        return fig
